        ...
        NavigationView {
            ...
            ZStack{
                ...
                VStack (){
                    ...
                    ActionButton(label: "Complete account", symbolName: "arrow.forward.circle.fill", fontColor: Color(hex: 0xffffff), backgroundColor: Color(hex: 0xBA55D3), isShareDaily: false, isDisabled: tagname == "" || name == "" || tagname.containsEmoji) {
                        saveUserDetails()
                    }
                }
                .padding()
